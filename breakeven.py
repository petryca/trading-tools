...
def print_help():
    print("Usage: breakeven.py <arg1>")
    print("Description: This script calculates the breakeven price for your trading positions.")
...
try:
    ...
    def main():
        if len(sys.argv) != 2:
            print("Usage: breakeven.py <trading-pair>")
            print("Example: breakeven.py BTCUSDT")
            sys.exit(1)
